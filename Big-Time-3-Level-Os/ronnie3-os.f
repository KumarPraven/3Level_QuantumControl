...
C.....Without using RWA............................*
C.....Off-Resonance case...........................*
C
      IMPLICIT DOUBLE PRECISION(a-h,o-z)
      PARAMETER(n=3,nt=64*1024)
C
...
C
     ...
     &             (dt/Es0)*(Es(i)-Esi(i))**2 )
         ...
         IF (itr==2000) WRITE(21,*) t, Ep(i), Es(i)
C
      END DO
      Jp=alpha*Jp
      Jc=beta*Jc
...
C
         ...
         F22=CDABS(a(2))**2
         F33=CDABS(a(3))**2
         IF (itr==2000) WRITE(23,7779) t, F11, F22, F33
...
C
      Epr=3.0D-02 !....per fs
      Esr=3.0D-02 !....per fs
C      Epr=2.5D-02 !....per fs
C      Esr=2.5D-02 !....per fs
C
