...
unset label
set label 1 "(c)" at 1750, 0.5, 0 left norotate back nopoint offset character 0, 0, 0
unset arrow
...
GNUTERM = "wxt"
pl './progress.dat' ti "" w l lw 5, './progress.dat' u 1:3 ti "" w l lt 3 lw 5, './progress.dat' u 1:4 ti "" w l lt 5 lw 5, './progress.dat' u 1:5 ti "" w l lt 7 lw 5 
#    EOF
